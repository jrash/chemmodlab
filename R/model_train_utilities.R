...
#'   list correspond each split performed by \code{\link{ModelTrain}}. The
#'   elements of the inner list correspond to each descriptor set.  The elements
#'   of the inner list are dataframes containing all model predictions for a
...
#'   that The predictions are replaced by predicted probabilities.  Predicted
...
#'   elements of the inner list are model accuracy measures for each model fit
