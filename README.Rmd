...
`chemmodlab` contains a suite of methods for fitting machine learning models and for validating the resulting models. It also contains methods for confidence bands and hypothesis tests for hit enrichment curves (see section *Confidence bands and hypothesis tests for hit enrichment curves*).
